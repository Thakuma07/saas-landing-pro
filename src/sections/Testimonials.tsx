  ...
  return (
    <div className={props.className}>
      <div
        ...
        style={{ animation: `ticker-vertical ${props.duration || 10}s linear infinite` }}
          ...
          ...new Array(2).fill(0).map((_, index) => (
            <React.Fragment key={index}>
              {props.testimonials.map(({ text, imageSrc, name, username }) => (
                <div className="card hover:-translate-y-1 transition duration-300 hover:shadow-xl" key={username}>
                  {/* Star rating */}
                  <div className="flex text-[#FFD700] mb-4 gap-0.5">
                    {[...Array(5)].map((_, i) => (
                      <motion.svg
                        key={i}
